...
function fillForm(submission) {
  ...
  // Handle resume: show current filename
  const resumeInput = document.getElementById("form-resume");
  if (resumeInput && submission.resumeFilename) {
    resumeInput.placeholder = `Current: ${submission.resumeFilename} (Upload new to replace)`;
    // Create a display element for current resume
    let resumeDisplay = document.getElementById("current-resume-display");
    if (!resumeDisplay) {
      resumeDisplay = document.createElement("div");
      resumeDisplay.id = "current-resume-display";
      resumeDisplay.style.marginBottom = "10px";
      resumeDisplay.style.marginTop = "10px";
      resumeDisplay.style.padding = "8px 12px";
      resumeDisplay.style.backgroundColor = "#e0f2fe";
      resumeDisplay.style.borderRadius = "6px";
      resumeDisplay.style.color = "#0369a1";
      resumeDisplay.style.fontSize = "14px";
      resumeInput.parentElement.insertBefore(resumeDisplay, resumeInput);
    }
